...
**Evaluator(s):** ____________________  
...
| **Evaluation Period** | Start: ________ End: ________ |
...
|---------|------------|------------------------|-------------------|----------------|
| Batch API | ☐ Yes ☐ No | __% | | |
| Cached Input | ☐ Yes ☐ No | __% | N/A | N/A |
| Prompt Caching | ☐ Yes ☐ No | __% | N/A | |
...
| Deprecation notice period | ____________ | |
...
| Enterprise support SLA (response time) | P1: ____ P2: ____ P3: ____ | |
| Dedicated account manager | ☐ Yes ☐ No (min spend: $____) | |
...
| Termination for convenience | ☐ Yes ☐ No — notice period: ____ | |
...
**Selected Vendor(s):** ____________________  
**Rationale:** ____________________  
**Contract Start Date:** ____________________  
**Next Re-evaluation Date:** ____________________
